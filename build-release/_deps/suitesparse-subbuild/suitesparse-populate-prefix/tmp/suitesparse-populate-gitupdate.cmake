...
execute_process(
  COMMAND "/usr/bin/git" show-ref "5.13.0-cmake.4"
  WORKING_DIRECTORY "/home/emdiso/c/HSIM/HSIM-for-Eigen/build-release/_deps/suitesparse-src"
...
if(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/remotes/")
  ...
  set(checkout_name "5.13.0-cmake.4")
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("5.13.0-cmake.4" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/5.13.0-cmake.4")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/emdiso/c/HSIM/HSIM-for-Eigen/build-release/_deps/suitesparse-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/emdiso/c/HSIM/HSIM-for-Eigen/build-release/_deps/suitesparse-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
